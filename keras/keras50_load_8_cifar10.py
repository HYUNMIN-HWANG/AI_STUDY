...
c10_x_test = np.load('../data/npy/c10_x_test.npy')
c10_y_train = np.load('.../data/npy/c10_y_train.npy')
c10_y_test = np.load('../data/npy/c10_y_test.npy')

# print(x_data)
# print(y_data)
print(c10_x_train.shape)  # (50000, 32, 32, 3)
print(c10_x_test.shape)   # (10000, 32, 32, 3)
print(c10_y_train.shape)  # (50000, 1)
print(c10_y_test.shape)   # (10000, 1)
