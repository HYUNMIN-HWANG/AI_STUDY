# tensorflow.keras.layers >> Reshape 레이어 사용
# input (n, 32, 32, 3) -> output (n, 32, 32, 3)
...
model.fit(x_train, y_train, epochs=2, batch_size=32,validation_split=0.2, verbose=1,callbacks=[es])
