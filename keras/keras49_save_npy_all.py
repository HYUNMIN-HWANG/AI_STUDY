...
np.save('../data/npy/f_mnist_x_train.npy', arr=fm_x_train)
np.save('../data/npy/f_mnist_x_test.npy', arr=fm_x_test)
np.save('../data/npy/f_mnist_y_train.npy', arr=fm_y_train)
np.save('../data/npy/f_mnist_y_test.npy', arr=fm_y_test)

#8. cifar10
(c10_x_train, c10_y_train), (c10_x_test, c10_y_test) = cifar10.load_data()
np.save('../data/npy/c10_x_train.npy', arr=c10_x_train)
np.save('../data/npy/c10_x_test.npy', arr=c10_x_test)
np.save('../data/npy/c10_y_train.npy', arr=c10_y_train)
np.save('../data/npy/c10_y_test.npy', arr=c10_y_test)

#9. cifar100
(c100_x_train, c100_y_train), (c100_x_test, c100_y_test) = cifar100.load_data()
np.save('../data/npy/c100_x_train.npy', arr=c100_x_train)
np.save('../data/npy/c100_x_test.npy', arr=c100_x_test)
np.save('../data/npy/c100_y_train.npy', arr=c100_y_train)
np.save('../data/npy/c100_y_test.npy', arr=c100_y_test)