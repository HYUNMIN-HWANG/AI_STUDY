...
print(np.max(x_data), np.min(x_data)) # 최댓값 711.0, 최솟값 0.0      ----> 최댓값 1.0 , 최솟값 0.0
print(np.max(x_data[0]))         # max = 396.9
...
# ModelCheckPoint
# loss :  6.48313045501709
# mae :  2.0182249546051025
# RMSE :  2.54619929949704
# R2 :  0.9224347566654254