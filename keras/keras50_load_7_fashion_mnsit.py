...
import numpy as np
fm_x_train = np.load('../data/npy/f_mnist_x_train.npy')
fm_x_test = np.load('../data/npy/f_mnist_x_test.npy')
fm_y_train = np.load('../data/npy/f_mnist_y_train.npy')
fm_y_test = np.load('../data/npy/f_mnist_y_test.npy')

# print(x_data)
# print(y_data)
print(fm_x_train.shape)  # (60000, 28, 28)
print(fm_x_test.shape)   # (10000, 28, 28)
print(fm_y_train.shape)  # (60000,)
print(fm_y_test.shape)   # (10000,)

# =========================== 모델을 완성하시오 ===========================

# x > preprocessing
# print(np.min(x_train),np.max(x_train))  # 0 ~ 255
x_train = fm_x_train.reshape(fm_x_train.shape[0],fm_x_train.shape[1],fm_x_train.shape[2],1)/255.
x_test = fm_x_test.reshape(fm_x_test.shape[0],fm_x_test.shape[1],fm_x_test.shape[2],1)/255.
...
y_train = to_categorical(fm_y_train)
y_test = to_categorical(fm_y_test)
...
# ModelCheckPoint
# loss :  0.32068130373954773
# acc :  0.8862000107765198
# y_test :  [9 1 8 1]
# y_pred :  [9 1 8 1]
