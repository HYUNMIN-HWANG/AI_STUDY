...
# model = load_model('../data/h5/k51_1_model1.h5')  # (1) 모델만 저장되어 있음, 컴파일을 안했기 때문에 에러가 뜬다.
# RuntimeError: You must compile your model before training/testing. Use `model.compile(optimizer, loss)`.

# (2) 컴파일, 훈련한 후 model.save  >> 모델과 가중치 함께 저장되어 있음
model = load_model('../data/h5/k51_1_model2.h5')    

# >>> 결과가 바로 나온다.
# loss :  0.05212588980793953
