...
dense2 = LSTM(60, activation='relu')(input2)
...
# model.fit([x1_train,x2_train], y1_train, epochs=1300, batch_size=3, validation_split=0.1, callbacks=[early_stopping])
...
# loss, mae :  [24.093996047973633, 3.4834465980529785]
# y_pred1 :  [[85.23748]]