...
print(train[0][0].shape)    # (1389, 128, 128, 3)   >> x_train
print(train[0][1].shape)    # (1389, )            >> y_train

print(valid[0][0].shape)     # (347, 128, 128, 3)  >> x_valid
print(valid[0][1].shape)     # (347, )          >> x_valid

# data numpy save
np.save('../data/image/gender/npy/keras67_train_x2.npy', arr = train[0][0]) 
np.save('../data/image/gender/npy/keras67_train_y2.npy', arr = train[0][1]) 
np.save('../data/image/gender/npy/keras67_valid_x2.npy', arr = valid[0][0]) 
np.save('../data/image/gender/npy/keras67_valid_y2.npy', arr = valid[0][1]) 
