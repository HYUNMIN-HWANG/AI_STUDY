...
x_train, x_test, y_train, y_test = train_test_split(x_train, y_train, train_size=0.9, shuffle=True, random_state=42)

print(x_train.shape, x_valid.shape, x_test.shape)  # (1250, 56, 56, 3) (347, 56, 56, 3) (139, 56, 56, 3)
print(y_train.shape, y_valid.shape, y_test.shape)  # (1250,) (347,) (139,)
...
lr = ReduceLROnPlateau(monitor='val_loss', factor=0.4, patience=20, mode='min')
