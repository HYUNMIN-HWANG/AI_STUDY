...
print(data.shape)   # (48000, 100, 100, 3)
print(label.shape)  # (48000,)

np.save('../data/LPD_competition/npy/data_x_train4.npy', arr=data, allow_pickle=True)
print('x save')
np.save('../data/LPD_competition/npy/data_y_train4.npy', arr=label, allow_pickle=True)
print('y save')
...
np.save('../data/LPD_competition/npy/data_x_pred4.npy', arr=pred, allow_pickle=True)
print('x save')
