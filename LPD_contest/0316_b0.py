...
path = '../data/LPD_competition/cp/cp_0316_1_{val_loss:.4f}.hdf5'
...
for train_index, test_index in kf.split(x_data) :
    ...
    model.fit(x_train, y_train, epochs=5, batch_size=32, validation_data=(x_val, y_val), callbacks=[es, lr, cp])
...
# model = load_model('../data/LPD_competition/cp/cp_0316_1_6.9301.hdf5')  # all 214
model = load_model('../data/LPD_competition/cp/cp_0316_1_6.9308.hdf5')  # all 718
...
submission.to_csv('../data/LPD_competition/sub_0316_1.csv', index=True)