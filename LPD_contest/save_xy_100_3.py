...
# train
np.save('../data/LPD_competition/npy/data_x_train3.npy', arr=xy_train[0][0], allow_pickle=True)
print('x save')
np.save('../data/LPD_competition/npy/data_y_train3.npy', arr=xy_train[0][1], allow_pickle=True)
print('y save')
...
# validation
np.save('../data/LPD_competition/npy/data_x_val3.npy', arr=xy_val[0][0], allow_pickle=True)
print('x save')
np.save('../data/LPD_competition/npy/data_y_val3.npy', arr=xy_val[0][1], allow_pickle=True)
print('y save')
...
# # predict
np.save('../data/LPD_competition/npy/data_x_pred3.npy', arr=xy_pred[0], allow_pickle=True)
print('x save')
