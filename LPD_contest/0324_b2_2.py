...
path = '../data/LPD_competition/cp/cp_0324_5_b2.hdf5'
...
model.save_weights('../data/LPD_competition/cp//cp_0324_5_b2_weights.h5')
...
# EarlyStopping 
# loss  0.005067327059805393
# acc  0.9983333349227905

#4. Predict
model = load_model('../data/LPD_competition/cp//cp_0324_5_b2.hdf5')
...
print("time >> " , time)    # time >>  2:23:04.269355
