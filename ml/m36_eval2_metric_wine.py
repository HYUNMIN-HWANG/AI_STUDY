...
model.fit(x_train, y_train, verbose=1, eval_metric=['merror','mlogloss','cox-nloglik'], eval_set=[(x_train, y_train), (x_test, y_test)])
# [9]     validation_0-merror:0.00704     validation_0-mlogloss:0.97675   validation_0-cox-nloglik:4.21546        validation_1-merror:0.00000     validation_1-mlogloss:0.98370   validation_1-cox-nloglik:2.72776
