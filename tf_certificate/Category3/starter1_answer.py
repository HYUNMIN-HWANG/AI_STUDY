...
def solution_model():
    ...
    model.fit_generator(train_generator, steps_per_epoch=len(train_generator)//batch, epochs=30, \
        validation_data=valid_generator, validation_steps=4, callbacks=[lr])
    ...
    # loss :  0.8044562339782715
    # acc :  0.682539701461792
