...
def solution_model():
    ...
    urllib.request.urlretrieve(url, 'C:\\Study\\tf_certificate\\Category4\\sarcasm.json')
    ...
    rl = ReduceLROnPlateau(monitor='val_loss', factor=0.4, patience=10, mode='min')

    # Compile, Train
    model.compile(loss='binary_crossentropy', optimizer='adam',metrics=['acc'])
    model.fit(pad_x_train, y_train, epochs=30, batch_size=16, validation_split=0.2, callbacks=[rl])
    ...
    # loss :  0.589999258518219
    # acc :  0.8133846521377563
...
if __name__ == '__main__':
    ...
    model.save("C:\\Study\\tf_certificate\\Category4\\mymodel.h5")
