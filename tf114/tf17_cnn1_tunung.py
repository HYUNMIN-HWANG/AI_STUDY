...
w1 = tf.get_variable("w1", shape=[3, 3, 1, 128],
                initializer=tf.compat.v1.initializers.he_normal(), regularizer=regularizer) # 4차원 맞춘다. : 3,3 kernel_size / 1 channel / 32 filter
...
w2 = tf.get_variable("w2", shape=[3, 3, 128, 64],
                    initializer=tf.compat.v1.initializers.he_normal(), regularizer=regularizer) # 4차원 맞춘다. : 3,3 kernel_size / 32 위의 output이 현재 레이어의 input  / 32 filter
...
w3 = tf.get_variable("w3", shape=[3, 3, 64, 32],
                    initializer=tf.compat.v1.initializers.he_normal(), regularizer=regularizer) 
