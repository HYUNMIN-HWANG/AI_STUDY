...
# print(x.shape)     # (N, 1, 48, 6)
# print(y.shape)     # (N, 48, 2)
# print(x_pred.shape)  # (81, 1, 48, 6)
...
x_train = x_train.reshape(x_train.shape[0], 1, 48, 6)
x_test = x_test.reshape(x_test.shape[0], 1, 48, 6)
x_val = x_val.reshape(x_val.shape[0], 1, 48, 6)
x_pred = x_pred.reshape(x_pred.shape[0], 1, 48, 6)
