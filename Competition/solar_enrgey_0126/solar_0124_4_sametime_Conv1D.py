...
for q in quantiles :
    ...
    hist = model.fit(x_train, y_train, epochs=10, batch_size=16, validation_data=(x_val, y_val), callbacks=[cp, lr])
...
# to csv
submission.to_csv('../data/DACON_0126/submission_0124_3.csv', index=False)  # score : 		
