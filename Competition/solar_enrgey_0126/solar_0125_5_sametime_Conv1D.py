...
for q in quantiles :
    ...
    cp_save = f'../data/modelcheckpoint/solar_0125_s5_q_{q:.1f}.hdf5'
    ...
    submission.to_csv(f'../data/DACON_0126/submission_0125_5_{q}.csv', index = False) 
...
# to csv
submission.to_csv('../data/DACON_0126/submission_0125_5.csv', index=False)  # score : 		
