...
np.save('../data/DACON_vision2/npy/vision_x2.npy', arr=x)
np.save('../data/DACON_vision2/npy/vision_y2.npy', arr=y)
...
x_pred[x_pred < 100] = 0
np.save('../data/DACON_vision2/npy/vision_x_pred2.npy', arr=x_pred)
