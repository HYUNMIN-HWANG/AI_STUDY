...
np.save('../data/DACON_vision2/npy/vision_x.npy', arr=x)
np.save('../data/DACON_vision2/npy/vision_y.npy', arr=y)
...
np.save('../data/DACON_vision2/npy/vision_x_pred.npy', arr=x_pred)
