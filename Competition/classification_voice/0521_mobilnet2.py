...
print(train_x.shape, train_y.shape, test_x.shape)   # (25520, 128, 157, 1) (25520,) (6100, 128, 157, 1)
...
cp_path = 'E:\\data\\classification_voice\\cp\\0521_mobilnet2.h5'
...
for train_idx, val_idx in split.split(train_x, train_y):
    ...
    sample_submission.to_csv(f"E:\\data\\classification_voice\\mobilenet_0521_2_{time}.csv", index=False)
...
kf1 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_1.csv")
kf2 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_2.csv")
kf3 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_3.csv")
kf4 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_4.csv")
kf5 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_5.csv")
kf6 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_6.csv")
kf7 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_7.csv")
kf8 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_2_8.csv")
...
for col in range(1,7) :
    ...
    sample_submission.to_csv(f"E:\\data\\classification_voice\\mobilenet_0521_mean2.csv", index=False)
    print("=============")
