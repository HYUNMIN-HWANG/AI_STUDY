...
- sr 22050으로 해보기   -> 성능 그닥
- melspectrogram 파라미터 조정 -> 성능 그닥
- 각 6개국의 데이터 수 똑같이 맞추기
- 악센트 특징 잡을 수 있는 전처리 방법 조사하기 
'''
...
for train_idx, val_idx in split.split(train_x, train_y):
    ...
    history = model.fit(x = x_train, y = y_train, batch_size = batch, validation_data = (x_val, y_val), epochs = 8)
    print("*******************************************************************")
    ...
    sample_submission.to_csv(f"E:\\data\\classification_voice\\baseline_0522_{time}.csv", index=False)
...
kf1 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_1.csv")
kf2 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_2.csv")
kf3 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_3.csv")
kf4 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_4.csv")
kf5 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_5.csv")
kf6 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_6.csv")
kf7 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_7.csv")
kf8 = pd.read_csv("E:\\data\\classification_voice\\baseline_0522_8.csv")
...
for col in range(1,7) :
    ...
    sample_submission.to_csv(f"E:\\data\\classification_voice\\baseline_0522_mean1.csv", index=False)
    print("=============")
