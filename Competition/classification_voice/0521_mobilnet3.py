...
#feature를 생성합니다.
# 파라미터 조정
def get_feature(data, sr = 22050, hop_length=512, n_fft=512):
    mel = []
    for i in data:
        # win_length 는 음성을 작은 조각으로 자를때 작은 조각의 크기입니다.
        # hop_length 는 음성을 작은 조각으로 자를때 자르는 간격을 의미합니다.
        # n_mels 는 적용할 mel filter의 개수입니다.
        mel_ = librosa.feature.melspectrogram(i, sr = sr, n_fft = n_fft, hop_length = hop_length)
        mel.append(mel_)
    mel = np.array(mel)
...
print(train_x.shape, train_y.shape, test_x.shape)   # (25520, 128, 216, 1) (25520,) (6100, 128, 216, 1)
...
cp_path = 'E:\\data\\classification_voice\\cp\\0521_mobilnet3.h5'
...
for train_idx, val_idx in split.split(train_x, train_y):
    ...
    sample_submission.to_csv(f"E:\\data\\classification_voice\\mobilenet_0521_3_{time}.csv", index=False)
...
kf1 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_1.csv")
kf2 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_2.csv")
kf3 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_3.csv")
kf4 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_4.csv")
kf5 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_5.csv")
kf6 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_6.csv")
kf7 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_7.csv")
kf8 = pd.read_csv("E:\\data\\classification_voice\\mobilenet_0521_3_8.csv")
...
for col in range(1,7) :
    ...
    sample_submission.to_csv(f"E:\\data\\classification_voice\\mobilenet_0521_mean3.csv", index=False)
    print("=============")
