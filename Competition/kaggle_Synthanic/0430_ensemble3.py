...
print(f"Current threshold is: {threshold}") #  0.28706671737496064
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0430_3.csv", index = False)

# submission_0430_3.csv 
# score 0.81730
