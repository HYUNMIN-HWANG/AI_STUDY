...
submission['submit_2'] = pd.read_csv("E:\\data\\kaggle_tabular\\submission\\submission_0430_5.csv")[TARGET]
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0430_f1.csv", index = False)

# submission_0430_f1.csv -> hhm2816 학원컴
# score : 0.81722
