...
print(f"Current threshold is: {threshold}") #  0.2418448329425257
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0430_1.csv", index = False)

# submission_0430_1.csv 
# score 0.81726
