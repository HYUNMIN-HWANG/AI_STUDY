...
print(f"Current threshold is: {threshold}") #  0.28365360680001445
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0430_5.csv", index = False)

# submission_0430_5.csv 
# score 0.81730
