...
parameters = {
    'max_depth': np.arange(3, 5, dtype=int),
    # 'min_samples_leaf':  np.arange(2, 5, dtype=int)
}

classifier = XGBClassifier(n_jobs = -1, n_estimators=1000 , tree_method = 'gpu_hist', use_label_encoder=False, predictor='cpu_predictor')#, LGBMClassifier
