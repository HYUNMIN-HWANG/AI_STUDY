...
print(f"Current threshold is: {threshold}") #   0.27911866596921486
submission['submit_1'] = (test_preds > threshold).astype(int)
submission['submit_2'] = pd.read_csv("E:\\data\\kaggle_tabular\\submission\\submission_0430_1.csv")[TARGET]
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0430_2.csv", index = False)

# submission_0430_2.csv 
# score 0.81730
