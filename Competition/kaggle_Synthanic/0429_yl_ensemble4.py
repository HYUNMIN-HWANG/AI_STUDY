...
print(f"Current threshold is: {threshold}") #  0.24077810474012645
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0429_voting8.csv", index = False)

#  submission_0429_voting8.csv -> hhm2816 학원컴
# score 0.81726