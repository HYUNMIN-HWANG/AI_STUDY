...
print(f"Current threshold is: {threshold}") #  0.24159945176264883
submission['submit_1'] = (test_preds > threshold).astype(int)
submission['submit_2'] = pd.read_csv("E:\\data\\kaggle_tabular\\submission\\submission_0429_voting5.csv")[TARGET]
...
submission[['PassengerId', TARGET]].to_csv("E:\\data\\kaggle_tabular\\submission_0429_voting6.csv", index = False)

# submission_0429_voting6.csv -> hhm2816 학원컴
# score 0.81730