...
for train_index, test_index in skf.split(train2, train['digit']) : # >>> x, y
    path = '../data/DACON_vision1/cp/0205_3_cp.hdf5'
    ...
    model.load_weights('../data/DACON_vision1/cp/0205_3_cp.hdf5')
    ...
    result += model.predict_generator(pred_generator, verbose=True)/50
    ...
    print(np.mean(val_loss_min))  # val_loss_mean : 
    print(np.mean(val_acc_max))  # val_acc_max : 
    model.summary()

sub['digit'] = result.argmax(1)
print(sub)
sub.to_csv('../data/DACON_vision1/0205_3_private3.csv', index=False)
