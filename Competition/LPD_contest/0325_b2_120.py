...
### npy load
x_data = np.load('../data/LPD_competition/npy/data_x_train6.npy', allow_pickle=True)
print(x_data.shape)    # (48090, 120, 120, 3)
...
print(x_train.shape, x_valid.shape)  # (43281, 120, 120, 3) (4809, 120, 120, 3)
...
path = '../data/LPD_competition/cp/cp_0325_1_b2.hdf5'
...
model.save_weights('../data/LPD_competition/cp//cp_0325_1_b2_weights.h5')
...
# EarlyStopping 43
# loss  0.007236206904053688
# acc  0.9970887899398804

#4. Predict
model = load_model('../data/LPD_competition/cp//cp_0325_1_b2.hdf5')
# model.load_weights('../data/LPD_competition/cp//cp_0324_3_b2_weights.h5')

print(">>>>>>>>>>>>>>>> predict >>>>>>>>>>>>>> ")

x_pred = np.load('../data/LPD_competition/npy/data_x_pred6.npy', allow_pickle=True)
print(x_pred.shape)     # (72000, 120, 120, 3)
...
submission.to_csv('../data/LPD_competition/sub_0325_1.csv', index=True)

end_now = datetime.datetime.now()
time = end_now - start_now
print("time >> " , time)    # time >>   1:57:45.784606
