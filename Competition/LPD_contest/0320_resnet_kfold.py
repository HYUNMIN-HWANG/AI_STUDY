...
path = '../data/LPD_competition/cp/cp_0320_1_resnet_kf.hdf5'
...
for train_index, valid_index in kf.split(x_data) :
    ...
    model.save_weights(f'../data/LPD_competition/cp/cp_0320_1_resnet_kf_weights_{i}.h5')
    ...
    #4. Predict
    # model = load_model('../data/LPD_competition/cp/cp_0320_1_resnet_kf.hdf5')
    ...
    submission.to_csv(f'../data/LPD_competition/sub_0320_1_{i}_weight.csv',index=True)
    # score 
...
submission.to_csv('../data/LPD_competition/sub_0320_1_mean.csv',index=True)
