...
path = '../data/LPD_competition/cp/cp_0318_1_mobile.hdf5'
...
# loss  0.028056694194674492
# acc  0.9947777986526489
'''
#4. Predict
submission = pd.read_csv('../data/LPD_competition/sample.csv', index_col=0)
# print(submission.shape) # (72000, 2)

model = load_model('../data/LPD_competition/cp/cp_0318_1_mobile.hdf5')
...
submission.to_csv('../data/LPD_competition/sub_0318_1.csv',index=True)


end_now = datetime.datetime.now()
time = end_now - start_now
print("time >> " , time)    # time >>  1:01:03.438091
