...
x = pd.concat(df_x)
x = x.values
print("x.shape ", x.shape)       # (6400000, 128)
print(x[0,:])
x = x.reshape(50000, 128, 128, 1)

y = train.iloc[:,1:]
print("y.shape ", y.shape)    # (50000, 26)

np.save('../data/DACON_vision2/npy/vision_x5.npy', arr=x)
np.save('../data/DACON_vision2/npy/vision_y5.npy', arr=y)
...
print(x_pred.shape)       #  (640000, 128)
x_pred = x_pred.reshape(5000, 128, 128, 1)

np.save('../data/DACON_vision2/npy/vision_x_pred5.npy', arr=x_pred)
