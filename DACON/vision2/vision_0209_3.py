...
#1. DATA
x = np.load('../data/DACON_vision2/npy/vision_x.npy')
y = np.load('../data/DACON_vision2/npy/vision_y.npy')
...
# loss :  655.867919921875
# acc :  0.03359999880194664
...
sub.to_csv('../data/DACON_vision2/sub_0209_2.csv', index=False)
print(sub.head())
