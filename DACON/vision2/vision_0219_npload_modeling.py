...
#1. DATA
x = np.load('../data/DACON_vision2/npy/vision_x4.npy')
y = np.load('../data/DACON_vision2/npy/vision_y4.npy')
x_pred = np.load('../data/DACON_vision2/npy/vision_x_pred4.npy')
print("<==complete load==>")

print(x.shape, y.shape, x_pred.shape) # (50000, 64, 64, 1) (50000, 26) (5000, 64, 64, 1)
...
print(x_train.shape, x_test.shape, x_valid.shape)  # (36000, 64, 64, 1) (5000, 64, 64, 1) (9000, 64, 64, 1)
...
for alph in alphabet :  # 한 알파벳씩 검증
    ...
    path = '../data/DACON_vision2/cp/vision_0219_1_{val_loss:.4f}.hdf5'
...
# mean loss :  0.695167763875081
# mean acc :  0.5283881437319976

sub.to_csv('../data/DACON_vision2/sub_0219_1.csv', index=False)
print(sub.head())
