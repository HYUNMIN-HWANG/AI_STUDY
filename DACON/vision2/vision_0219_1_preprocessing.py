...
x = pd.concat(df_x)
x = x.values
print("x.shape ", x.shape)       # (3200000, 64)
print(x[0,:])
...
np.save('../data/DACON_vision2/npy/vision_x4.npy', arr=x)
np.save('../data/DACON_vision2/npy/vision_y4.npy', arr=y)
'''
...
print(x_pred.shape)       # (320000, 64)
x_pred = x_pred.reshape(5000, 64, 64, 1)

np.save('../data/DACON_vision2/npy/vision_x_pred4.npy', arr=x_pred)
