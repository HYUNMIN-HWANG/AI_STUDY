...
for q in quantiles :
    ...
    cp_save = f'../data/modelcheckpoint/solar_0126_s4_q_{q:.1f}.hdf5'
    ...
    submission.to_csv(f'../data/DACON_0126/submission_0126_4_{q}.csv', index = False)  # score : 
...
# to csv
submission.to_csv('../data/DACON_0126/submission_0126_4.csv', index=False)  # score : 
