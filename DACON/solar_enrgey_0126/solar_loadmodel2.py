...
x_train, x_test, y_train, y_test = \
    train_test_split(x, y, train_size=0.8, shuffle=True, random_state=311)
x_train, x_val, y_train, y_val, = \
    train_test_split(x_train, y_train, train_size=0.8, shuffle=True, random_state=311)
...
# 수정 한 후
# print(x_train.shape)    # (33546, 288)
# print(x_test.shape)     # (10484, 288)
# print(x_val.shape)      # (8387, 288)

# print(y_train.shape)   # (33546, 96)
# print(y_test.shape)    # (10484, 96)
# print(y_val.shape)     # (8387, 96)

# print(x_train[:15])

# StandardScaler를 하기 위해서 2차원으로 변환   # 삭제
...
for q in quantiles :
    ...
    #2. Modeling
    # model = modeling()
    cp_load = f'../data/modelcheckpoint/solar_0122_q_{q:.1f}.hdf5'
...
print(loss_mean)    # 0.9475033548143175


# to csv
submission.to_csv('../data/DACON_0126/submission_0122_3.csv', index=False)  # score : 2.327856359
