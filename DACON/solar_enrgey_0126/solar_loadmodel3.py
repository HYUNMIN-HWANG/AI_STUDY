...
for q in quantiles :
    ...
    #2. Modeling
    # model = modeling()
    # cp_load = f'../data/DACON_cp/save/solar_0124_s1_q_{q:.1f}.hdf5'
    # cp_load = f'../data/DACON_cp/save/solar_0124_s2_q_{q:.1f}.hdf5'
    # cp_load = f'../data/DACON_cp/save/solar_0124_s3_q_{q:.1f}.hdf5'
...
# to csv
# submission.to_csv('../data/DACON_0126/0124_1.csv', index=False)  # score : 
# submission.to_csv('../data/DACON_0126/0124_2.csv', index=False)  # score : 
# submission.to_csv('../data/DACON_0126/0124_3.csv', index=False)  # score : 
# submission.to_csv('../data/DACON_0126/0125_1.csv', index=False)  # score : 
submission.to_csv('../data/DACON_0126/0123_1.csv', index=False)  # score : 

# 0124_1
# loss_mean :  3.3270494010713367
# 9 loss :  [1.8412226438522339, 3.0747177600860596, 3.281693696975708, 5.05129337310791, 4.587679386138916, 4.474442481994629, 3.667640447616577, 2.608302593231201, 1.356452226638794]

# 0124_2
# loss_mean :  3.595234817928738
# 9 loss :  [2.0967469215393066, 3.3477559089660645, 4.251720428466797, 5.4496564865112305, 5.200864315032959, 4.373458385467529, 3.8236122131347656, 2.45139741897583, 1.3619012832641602]

# 0124_3
# loss_mean :  3.04685996638404
# 9 loss :  [2.1996116638183594, 3.483494281768799, 4.184686183929443, 4.306445121765137, 3.9919776916503906, 3.474959135055542, 2.7648932933807373, 1.9702142477035522, 1.0454580783843994]
