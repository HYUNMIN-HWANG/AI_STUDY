...
for q in quantiles :
    ...
    cp_save = f'../data/modelcheckpoint/solar_0122_{q:.1f}.hdf5'
    cp = ModelCheckpoint(filepath=cp_save, monitor='val_loss', save_best_only=True, verbose=1, mode='min')
    model.fit(x_train, y_train, epochs=1000, batch_size=48, validation_data=(x_val, y_val), callbacks=[es, cp, lr])
...
print(loss_mean)    # 1.1909793516000111
