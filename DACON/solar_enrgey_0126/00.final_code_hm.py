...
def Add_features(data):
    data['cos'] = np.cos(np.pi/2 - np.abs(data['Hour']%12 - 6)/6*np.pi/2)   # 이거 어떻게 설명해야 하는거지?????
...
# print(df_train.columns)   # Index(['Day', 'TARGET', 'GHI', 'DHI', 'DNI', 'T-Td', 'Target1', 'Target2'], dtype='object')
...
plt.show()
# 기준 : Target1, Target2
# 상관계수 0.6 이상인 컬럼만 사용한다. : Target, GHI, DHI, DNI, T-Td
